...
class Apu {
    ...
    fun read(address: UShort): UByte {
        ...
        return when (add) {
            ...
            0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F -> waveRam[add - 0x10].toUByte()
            else -> 0xFF.toUByte()
        }
    }
    ...
    fun write(address: UShort, data: UByte) {
        ...
        when (add) {
            ...
            0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F -> waveRam[add and 0xF] =
                data.toByte()
